...
export const rollDice = () => {
    return Array.from({ length: 4 }, () => Array.from({ length: 4 }, () => Math.round(Math.random()).toString()).join(""));
};
// Merges two binary strings using bitwise XOR operation
export const mergeTiles = (tile1, tile2) => {
...
export const performMulligan = (hand) => {
    if (hand.length !== 4) {
...
export const updateBoard = (currentBoard, row, col, newFigure) => {
...
export const checkForWin = (board, position) => {
